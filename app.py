...
def handle_image(event):
    ...
    with graph.as_default():
        ...
        line_bot_api.reply_message(
            event.reply_token,
            TextSendMessage(
                text="この犬は["+classes[preds.argmax()]+"]ですね！"
            )
        )
